...
#inertia_eq_df['Total Inertia [MWs]'] = inertia_eq_df['Total Inertia [MWs]'].mask(inertia_eq_df['Total Inertia [MWs]'] < 0.1)
...
fig.update_layout(
    ...
    yaxis=dict(
        tickmode='array',
        tickvals=list(range(5000, int(gen_es_apr28_df['Total'].max()) + 5000, 5000))
    ),
    hovermode='x unified',
    showlegend=True,
    legend=dict(
